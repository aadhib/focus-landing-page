/*! ------------------------------------------------
 * Project Name: Focus Services -  
 * Project Description: Focus Services - functional and beautifully designed   to kick-start your project
 * Tags: Multixion, coming soon, under construction, template, landing page, portfolio, one page, responsive, html5, css3, creative, clean, agency, personal page
 * Version: 1.0.1
 * Build Date: May 2023
 * Last Update: January 2024
 * This product is available exclusively on Themeforest
 * Author: Multixion
 * Author URI: https://themeforest.net/user/Multixion
 * File name: app.js
 * ------------------------------------------------
